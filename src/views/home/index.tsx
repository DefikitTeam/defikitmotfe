...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    if (focusPools.length > 0) {
      const kingPool = allPool.find((pool) => focusPools.includes(pool.id));
              ...
              <div className="flex flex-col">
                <Tooltip title={t('SORT_INCREASE')}>
                  <CaretUpOutlined
                    ...
                    onClick={() =>
                      handleClickSortFilter(PoolStatusSortFilter.ASC)
                    }
                  />
                </Tooltip>
                ...
                <Tooltip title={t('SORT_DECREASE')}>
                  <CaretDownOutlined
                    ...
                    onClick={() =>
                      handleClickSortFilter(PoolStatusSortFilter.DESC)
                    }
                  />
                </Tooltip>
              </div>
