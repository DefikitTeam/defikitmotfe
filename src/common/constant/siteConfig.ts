export const siteConfig = {
    title: 'Rocket Launch',
    description: "Mother Of Token - Rocket Launch is a decentralized platform for launching tokens",
    ...
    landing: 'https://defikit-mot.s3.ap-southeast-1.amazonaws.com/rocket_launch.jpg'
}
