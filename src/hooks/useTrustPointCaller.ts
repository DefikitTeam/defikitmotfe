...
export function useTrustPointCaller() {
  ...
  return {
    useMintWithSignature: {
      actionAsync: (params: { id: string; signature: string | number }) => {
      ...
      isLoadingAgreedMintWithSignature: mintWithSignatureListener.isLoading,
      isLoadingInitMintWithSignature: mintWithSignatureWatcher.isPending,
      isError:
        mintWithSignatureListener.isError || mintWithSignatureWatcher.isError
    },
