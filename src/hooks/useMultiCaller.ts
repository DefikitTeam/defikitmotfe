  ...
  return {
    ...
    useCreateRocketToken: {
      actionAsync: (params: {
        ...
        return multiCaller.createRocketToken(createRocketTokenWatcher, params);
      },
      ...
      isError:
        createRocketTokenListener.isError || createRocketTokenWatcher.isError
    },
    useCreateLaunchPool: {
      actionAsync: (params: {
        token: string;
        ...
        return multiCaller.createLaunchPool(createLaunchPoolWatcher, params);
      },
      isConfirmed: creeateLaunchPoolListener.isSuccess,
      isLoadingAgreedCreateLaunchPool: creeateLaunchPoolListener.isLoading,
      isLoadingInitCreateLaunchPool: createLaunchPoolWatcher.isPending,
      isError:
        creeateLaunchPoolListener.isError || createLaunchPoolWatcher.isError
    },
    useLaunchPool: {
      actionAsync: (params: {
        // token
    ...
    useSellToken: {
      ...
      isError: sellTokenMultiListener.isError || sellTokenMultiWatcher.isError
    },
    ...
    useClaimFundLottery: {
      ...
      isLoadingInitSpinLottery: spinLotteryWatcher.isPending,
      isError: claimFundLotteryListener.isError || spinLotteryWatcher.isError
    },
    ...
    useDepositForLottery: {
      actionAsync: (params: {
        ...
        return multiCaller.depositForLottery(depositForLotteryWatcher, params);
      },
      isConfirmed: depositForLotteryListener.isSuccess,
      isLoadingAgreedDepositForLottery: depositForLotteryListener.isLoading,
      isLoadingInitDepositForLottery: depositForLotteryWatcher.isPending,
      isError:
        depositForLotteryListener.isError || depositForLotteryWatcher.isError,

      error: depositForLotteryListener.error || depositForLotteryWatcher.error
    },

    useWithdrawFundLottery: {
      actionAsync: (params: { poolAddress: string; amountETH: string }) => {
      ...
      isLoadingAgreedWithdrawFundLottery: withdrawFundLotteryListener.isLoading,
      isLoadingInitWithdrawFundLottery: withdrawFundLotteryWatcher.isPending,
      isError:
