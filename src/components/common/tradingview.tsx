                    ...
                    tickMarkFormatter: (
                        ...
                        switch (tickMarkType) {
                            ...
                            case TickMarkType.TimeWithSeconds:
                                const timeFormatterWithSeconds =
                            ...
                            if (timeframe === 'minute') {
                                arrayData = data?.data?.poolMinuteDatas.map(
                                    (item: PoolDataMinuteChart) => ({
                                        ...
                                        low: Number(
                                            new BigNumber(item.priceLowest)
                                        ),
                                        high: Number(
                                            new BigNumber(item.priceHighest)
                                        ),
                                        open: Number(
                                            new BigNumber(item.priceOpen)
                                        ),
                                        close: Number(
                                            new BigNumber(item.price)
                                        ),
                                        volume: Number(
                                            new BigNumber(item.volumeETH)
                                        )
                                    })
                                );
