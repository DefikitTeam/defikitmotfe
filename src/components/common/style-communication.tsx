...
const StyleCommunication = ({ mode }: { mode: string }) => {
    ...
    if (mode === 'launch-pool') {
        ...
        const onDelete =
            (name: 'all' | 'chat' | 'post', index: number) => () => {
                setData({
                    ...data,
                    aiAgent: {
                        style: {
