...
>(
  ...
  async (params, { rejectWithValue }) => {
    try {
      ...
      const data =
        await servicePool.getTop100TrustPointWalletAndTokenMonthly(params);
...
export const trustPointMonthlyWalletTokenSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getTop100TPMonthlyWalletAndToken.fulfilled, (state, action) => {
      ...
      .addCase(getTop100TPMonthlyWalletAndToken.rejected, (state, action) => {
