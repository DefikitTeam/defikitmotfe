...
>(
  ...
  async (params, { rejectWithValue }) => {
    try {
      ...
      const data = await servicePool.getTop100TrustPointWalletAndToken(params);
...
export const trustPointDailyWalletTokenSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getTop100TPDailyWalletAndToken.fulfilled, (state, action) => {
      ...
      .addCase(getTop100TPDailyWalletAndToken.rejected, (state, action) => {
