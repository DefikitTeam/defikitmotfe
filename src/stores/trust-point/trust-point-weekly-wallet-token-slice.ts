...
>(
  ...
  async (params, { rejectWithValue }) => {
    try {
      ...
      const data =
        await servicePool.getTop100TrustPointWalletAndTokenWeekly(params);
...
export const trustPointDailyWalletTokenSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getTop100TPWeeklyWalletAndToken.fulfilled, (state, action) => {
      ...
      .addCase(getTop100TPWeeklyWalletAndToken.rejected, (state, action) => {
